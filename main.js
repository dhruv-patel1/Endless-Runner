...
const gSoundOne = () =>{
    const listener = new THREE.AudioListener();
        ...
        audioLoader.load('./assets/sounds/bg1.mp3', (buffer) =>{
...
const addCharacter = () =>{
    ...
    loader.load('/assets/character/scene.gltf', (gltf) =>{
...
const createCactus = () =>{
    ...
    const texture = loader.load('/assets/cactus_texture.jpg');
...
const coinSound = () =>{
    ...
    const sound = new THREE.Audio(listener);
    const audioLoader = new THREE.AudioLoader();
    audioLoader.load('./assets/sounds/coin.wav', (buffer) =>{
        sound.setBuffer(buffer);
        sound.setLoop(false);
        sound.setVolume(0.2);
        sound.play();
...
const deathSound = () =>{
    ...
    const sound = new THREE.Audio(listener);
    const audioLoader = new THREE.AudioLoader();
    audioLoader.load('./assets/sounds/death.wav', (buffer) =>{
        sound.setBuffer(buffer);
        sound.setLoop(false);
        sound.setVolume(0.2);
        sound.play();
...
const createStars = () =>{
    ...
    let loader = new THREE.TextureLoader();
    const texture = loader.load('/assets/circle.png');
...
const createMoon = () =>{
    ...
    const texture = loader.load("/assets/moon_texture.jpg");
...
const createSun = () =>{
    ...
    const loader = new THREE.TextureLoader();
    const texture = loader.load("/assets/glow.png");
